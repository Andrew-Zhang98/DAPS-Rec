...
class AbstractDataset(metaclass=ABCMeta):
    ...
    def filter_triplets(self, df):
        ...
        #     print("good_item:", len(good_items))
        ...
        print("all_item:", len(df.groupby('sid').size()))
        print("all_users:", len(df.groupby('uid').size()))
        ...
        print("good_item:", len(df.groupby('sid').size()))
        print("good_users:", len(df.groupby('uid').size()))
    ...
    def split_df(self, df, user_count):
        if self.args.split == 'leave_one_out':
            ...
            ll = [len(ii) for ii in user2items]
            print("avg_length:", np.mean(ll))
            print("action_num:", np.sum(ll))
            train, val, test = {}, {}, {}
