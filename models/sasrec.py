...
class SASRec(nn.Module):
    def __init__(self, args):
        ...
        # self.recover = RecoverLengthLayer(self.n_heads, self.hidden_size, self. inner_size, self.hidden_dropout_prob, self.attn_dropout_prob, self.hidden_act, self.layer_norm_eps)
...
class SASRecModel(BaseModel):
    ...
    # def out(self, x):
    #     test_item_emb = self.sasrec.embedding.token.weight
