...
parser.add_argument('--train_negative_sampling_seed', type=int, default=1)
...
parser.add_argument('--test_negative_sampling_seed', type=int, default=1)
...
parser.add_argument('--max_len', type=int, default=None, help='Length of sequence for bert')
# DAE #
...
# GRU4REC
# parser.add_argument('--gru_max_len', type=int, default=None, help='Length of sequence for bert')
# parser.add_argument('--sas_num_items', type=int, default=None, help='Number of total items')
parser.add_argument('--gru_layers', type=int, default=None, help='Number of gru layers')
parser.add_argument('--gru_hidden_units', type=int, default=None, help='Size of hidden vectors (d_model)')
parser.add_argument('--gru_dropout', type=float, default=None, help='Dropout probability to use throughout the model')
# SASRec #
# parser.add_argument('--sas_max_len', type=int, default=None, help='Length of sequence for sas')
# parser.add_argument('--sas_num_items', type=int, default=None, help='Number of total items')
parser.add_argument('--sas_n_layers', type=int, default=None, help='Length of sequence for bert')
parser.add_argument('--sas_n_heads', type=int, default=None, help='Number of total items')
parser.add_argument('--sas_hidden_size', type=int, default=None, help='Size of hidden vectors (d_model)')
parser.add_argument('--sas_inner_size', type=int, default=None, help='Number of transformer layers')
parser.add_argument('--sas_hidden_dropout_prob', type=float, default=None, help='Number of heads for multi-attention')
parser.add_argument('--sas_attn_dropout_prob', type=float, default=None, help='Number of heads for multi-attention')
parser.add_argument('--sas_hidden_act', type=str, default=None, help='Dropout probability to use throughout the model')
parser.add_argument('--sas_layer_norm_eps', type=float, default=None, help='Length of sequence for bert')
parser.add_argument('--sas_initializer_range', type=float, default=None, help='Number of total items')
